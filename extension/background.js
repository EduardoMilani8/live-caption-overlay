// Forwards events to the local live-caption app. Content scripts can't
// reliably reach 127.0.0.1 under the site's CSP; the background script can,
// thanks to the host permission. Badge shows "ERR" while the app is unreachable.
